...
def run():
    ...
    st.markdown(
        ...
        Notre modèle Random Forest d'entrainement obtient un score de précision de 69,56%. Et permet une classification correcte des différents métiers cible (avec là encore des performances assez inégales pour les métiers de : Data Engineer et de MLObs).
    ...
    def class_model():
            ...
            seaborn_skill = st.selectbox('Utilisez vous seanborn ?', seaborn_list)
